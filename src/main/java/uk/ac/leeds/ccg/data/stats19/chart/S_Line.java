 ...
 * the License.
 */
package uk.ac.leeds.ccg.data.stats19.chart;
 ...
 */
public class S_Line extends uk.ac.leeds.ccg.chart.core.Chart_Line {
    ...
    public S_Line(Generic_Environment e) {
        super(e);
    }
     ...
     */
    public S_Line(Generic_Environment e, ExecutorService es, Path f,
...
//        drawYZero = true;
            ...
            S_Line chart = new S_Line(e, es, file, format, title,
